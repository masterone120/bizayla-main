...
const Service = () => {
  ...
  // Get service cards with proper type checking and fallback
  const serviceCardsData = t("service.serviceCards");
  const serviceCards: ServiceCard[] = Array.isArray(serviceCardsData)
    ? (serviceCardsData as ServiceCard[])
    : [];
    ...
    <>
            ...
            <div className="row">
              <div className="grid lg:grid-cols-4 grid-cols-1 gap-4">
                {serviceCards && serviceCards.length > 0 ? (
                      ...
                      <div className="service_single_item style_two style_three">
                        <div className="service_thumb">
                          ...
                          <div className="service_icon">
                            <Link
                              href={getLocalizedPath(`/service/${service.id}`)}
                            >
                              <Image
                  ...
                  // Fallback content if serviceCards is not available
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-5">
              <div className="call-right">
                ...
                <div className="advisar_btn style_two style_four">
                  <Link href="/contact">
      ...
      <section className="pricing-area style_two">
          ...
          <div className="row align-items-center">
            <div className="col-lg-5">
              ...
              <div className="pricing_list">
                <ul>
                  <li>
                    <img src="/images/home_two/check_pricing.png" alt="" />{" "}
              ...
              <div className="row">
                  ...
                  <div className="pricing-single-items style_two">
                    <div className="pricing_inner">
                      <div className="pricing_icon">
                        <img src="/images/home_two/price_icon_01.png" alt="" />
                      </div>
                ...
                <div className="col-lg-6 col-md-6">
                  <div className="pricing-single-items style_two upper">
                    <div className="pricing_inner">
                      <div className="pricing_icon">
                        <img src="/images/home_two/price_icon_02.png" alt="" />
                      </div>
                      <div className="pricing-title">
                        <h3>
        ...
        <div className="pricing_shape bounce-animate">
          <img src="/images/home_two/pricing_shape1.png" alt="" />
        </div>
      </section>
      {showModalstarter && (
        <div
